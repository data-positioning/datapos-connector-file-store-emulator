...
class Ie {
  ...
  toolConfigs;
  constructor(t) {
    this.abortController = void 0, this.config = re, this.toolConfigs = t;
  }
  //━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  //#region: Operations.
  /**
  ...
  async previewObject(t, i) {
    ...
    try {
      ...
      const p = await (await y(t.toolConfigs, "csv-parse")).determineSchemaConfig(n.text, N), r = performance.now() - o;
      return {
        asAt: d,
        columnConfigs: [],
