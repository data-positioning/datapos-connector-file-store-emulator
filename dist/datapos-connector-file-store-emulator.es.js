...
class ee {
  ...
  async previewObject(t) {
    ...
    try {
      ...
      const c = await (await m(this.toolConfigs, "csv-parse")).parseText(a.text, P), p = this.engineUtilities.inferDataTypes(c.parsedRecords);
      return {
        asAt: d,
        columnConfigs: p.columnConfigs,
