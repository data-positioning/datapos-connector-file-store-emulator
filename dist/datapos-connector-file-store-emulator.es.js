...
const m = (t) => /* @__PURE__ */ x(t.map((e) => /* @__PURE__ */ S(e)));
...
class Ce {
  ...
  async retrieveRecords(e, i, d, o) {
    ...
    return console.log(1234, s), new Promise((l, n) => {
      try {
        e.abortController = new AbortController();
        ...
        r.on("readable", () => {
          try {
            let p;
            for (; (p = r.read()) !== null; )
              a.throwIfAborted(), b.push(p), !(b.length < ze) && (d(b), b = []);
          } catch (p) {
