...
class te {
  ...
  async auditObjectContent(t, i) {
    ...
    try {
      ...
      const d = await m(this.toolConfigs, "csv-parse"), s = { delimiter: t.valueDelimiterId, info: !1, relax_column_count: !0, relax_quotes: !0 }, o = `${f}/fileStore${t.path}`, a = await d.parseStream(t, s, o, this.abortController, i);
