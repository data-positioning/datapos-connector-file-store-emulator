...
}, ee = "0.2.273", te = "Connector failed to abort preview object operation.", ie = "Connector failed to abort retrieve all records operation.", de = 4096, oe = 1e3, u = "https://sample-data-eu.datapos.app";
class se {
  abortController;
  config;
  connectionConfig;
