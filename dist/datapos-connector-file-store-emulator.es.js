...
}, de = "0.2.278", oe = "Connector failed to abort preview object operation.", se = "Connector failed to abort retrieve all records operation.", ae = 4096, ne = 1e3, h = "https://sample-data-eu.datapos.app";
class ce {
  abortController;
  config;
  connectionConfig;
