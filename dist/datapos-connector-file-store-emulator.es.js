...
function v(t, e, i, d, a) {
  ...
  }, l = t.kind === "schema", y = a?.message ?? t.message ?? /* @__PURE__ */ F(t.reference, n.lang) ?? (l ? /* @__PURE__ */ T(n.lang) : null) ?? d.message ?? /* @__PURE__ */ _(n.lang);
...
}, de = "0.2.279", oe = "Connector failed to abort preview object operation.", se = "Connector failed to abort retrieve all records operation.", ae = 4096, ne = 1e3, h = "https://sample-data-eu.datapos.app";
class ce {
  abortController;
  config;
  connectionConfig;
