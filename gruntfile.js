...
module.exports = (grunt) => {
    ...
    grunt.registerTask('build', ['run:rollup_es', 'run:rollup_umd', 'run:copyToFirebase', 'updateFirestore']); // cmd+shift+b.
    ...
    grunt.registerTask('release', ['bump', 'run:rollup_es', 'run:rollup_umd', 'run:copyToFirebase', 'updateFirestore']); // cmd+shift+r.
