 ...
 * @returns {number}
 */
export function add_my_numbers(left, right) {
    const ret = wasm.add_my_numbers(left, right);
    return ret;
}
 ...
 * @returns {number}
 */
export function checksum_from_rust(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.checksum_from_rust(ptr0, len0);
    return ret >>> 0;
}
