...
A TypeScript library that implements the File Store Emulator data connector by Datapos. It provides easy access to a curated set of files for demonstration or evaluation purposes.
